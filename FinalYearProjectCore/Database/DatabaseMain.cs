...
namespace FinalYearProjectCore.Database
{
    public class DatabaseMain
    {
        ...
        #region DB Constants
        public const string DatabaseFilename = "FinalYearProjectCore.db3";
        ...
        public static string DatabasePath => Path.Combine(AppContext.BaseDirectory, "TestData", DatabaseFilename);
